...
const recordPath_1 = require("./recordPath");
function query_operators(record, filters) {
    for (const key in filters) {
        const filter = filters[key];
        const value = (0, recordPath_1.recordPath)(record, key);
        for (const operator in filter) {
            ...
            switch (operator) {
                ...
                case '$in':
                    {
                        const normalizedArray = (0, normalizeArray_1.normalizeArray)(value);
                ...
                case '$avg':
                    ...
                    break;
                case '$avg': {
                    const normalized = (0, normalizeArray_1.normalizeArray)(value);
