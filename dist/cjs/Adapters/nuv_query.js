...
exports.nuv_query = void 0;
const recordPath_1 = require("../Functions/recordPath");
const queryOperators_1 = require("../Functions/queryOperators");
...
class nuv_query {
    ...
    indexes = null;
    constructor(indexes) {
        this.vector = new vectors_1.default(indexes);
    ...
    applyFilters(records, filters) {
        return Object.entries(records).filter(([docId, data]) => {
            return (0, queryOperators_1.query_operators)(data, filters);
    ...
    *chunkData(data, chunkSize) {
    ...
    deepGet(record, path) {
        const result = (0, recordPath_1.recordPath)(record, path);
        return result;
    }
}
exports.nuv_query = nuv_query;
